			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/avatar.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="side-item side-item-category">{{ trans('main.General') }}</li>
					...
					<li class="slide ">
						...
						<span class="side-menu__label">{{ trans('main.General Data') }}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							@can('عرض الألبومات')
								<li>
									<a class="slide-item" href="{{ url('/' . ($page = 'albums')) }}">{{ trans('main.Albums') }}</a>
								</li>
							@endcan
						</ul>
					</li>
					...
					@can('المستخدمين')
						<li class="side-item side-item-category">{{ trans('main.Users') }}</li>
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
								<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
									<path d="M0 0h24v24H0V0z" fill="none" />
								...
								<span class="side-menu__label">{{ trans('main.Users') }}</span>
								<i class="angle fe fe-chevron-down"></i>
							</a>
							<ul class="slide-menu">
								@can('قائمة المستخدمين')
									<li>
										<a class="slide-item" href="{{ url('/' . ($page = 'users')) }}">{{ trans('main.Users List') }}</a>
									</li>
								@endcan

								@can('صلاحيات المستخدمين')
									<li>
										<a class="slide-item" href="{{ url('/' . ($page = 'roles')) }}">{{ trans('main.Users Roles') }}</a>
									</li>
								@endcan
							</ul>
						</li>
